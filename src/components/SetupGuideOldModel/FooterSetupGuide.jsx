...
const Footer = () => {
  return (
    <footer className="bg-[#1a1a1a] text-white w-full">
      ...
      {/* TOP SECTION */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-8 grid grid-cols-1 sm:grid-cols-2 lg:flex lg:flex-row gap-8 lg:gap-12">
        ...
        {/* QUICK LINKS */}
          ...
          <ul className="space-y-2.5 text-sm">
            ...
            <li><Link href="/step-by-step-setup-guide/" className="text-gray-300 hover:text-white transition">Step-by-Step HP Printer Setup</Link></li>
            <li><Link href="/hp-printer-setup-install" className="text-gray-300 hover:text-white transition">HP Printer Setup & Install</Link></li>
            <li><Link href="/hp-printer-offline-fix" className="text-gray-300 hover:text-white transition">HP Printer Offline Fix</Link></li>
            <li><Link href="/hp-printer-troubleshooting" className="text-gray-300 hover:text-white transition">HP Printer Troubleshooting</Link></li>
            <li><Link href="/hp-printer-not-printing" className="text-gray-300 hover:text-white transition">HP Printer Not Printing</Link></li>
          </ul>
        </div>
        ...
        {/* <div>
          ...
          <ul className="space-y-2.5 text-sm">
            ...
            <li><Link href="/return-exchange-policy" className="text-gray-300 hover:text-white transition">Return and Refund Policy</Link></li>
        ...
        {/* QUICK CONTACT */}
          ...
          <div className="space-y-3 text-sm text-gray-300">
            ...
            <p>Website : <a href="https://www.smarteprint.com" target="_blank" rel="noopener noreferrer" className="text-red-500 hover:text-red-400 transition">www.smarteprint.com</a></p>
          </div>
        </div>
