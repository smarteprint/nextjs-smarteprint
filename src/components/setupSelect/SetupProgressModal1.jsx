                ...
                <div className="px-5 md:px-8 py-6 md:py-8">
                    <div className="flex items-center mb-6">
                        ...
                        <div className="flex-1 min-w-0">
                            <div className="text-lg md:text-xl font-bold text-gray-800 leading-tight truncate"></div>
                            <div className="text-gray-500 text-xs md:text-sm mt-0.5">Authorized User</div>
                        </div>
                    </div>
