...
const IssueSelector = () => {
  ...
  const handleFinalSubmit = (e, form) => {
    ...
    setTimeout(() => {
      ...
      setUserName(name);
      setPrinterModel(form.model?.trim() || '');
      setShowModal(true);
    }, 2000);
  };
  ...
  if (showError) {
    return <div className="fixed inset-0 z-50 bg-white flex items-center justify-center"><ErrorModal open={showError} onClose={() => setShowError(false)} printer="" onChat={() => {
