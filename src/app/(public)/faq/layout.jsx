export const metadata = {
  ...
  description: 'Find answers to common questions about ordering, shipping, returns, printer support, and services offered by Smart ePrint.',
  alternates: {
    canonical: 'https://www.smarteprint.com/faq',
  },
  openGraph: {
    title: 'Frequently Asked Questions (FAQ) | Smart ePrint',
    description: 'Find answers to common questions about ordering, shipping, returns, printer support, and services offered by Smart ePrint.',
    url: 'https://www.smarteprint.com/faq',
  },
};
...
const breadcrumbSchema = {
  ...
  'itemListElement': [
    ...
    },
    {
      ...
      'position': 2,
      'name': 'FAQ',
      'item': 'https://www.smarteprint.com/faq'
    }
  ]
};
...
const faqSchema = {
  ...
  'mainEntity': [
    {
      '@type': 'Question',
      'name': 'What is Smart ePrint?',
      'acceptedAnswer': {
        '@type': 'Answer',
        'text': 'Smart ePrint is an independent online store offering printers, inks, toners, and printing accessories across the United States and Canada. We provide genuine products, competitive prices, and expert customer support to make your printing experience simple and reliable.'
      }
    },
    {
      '@type': 'Question',
      'name': 'Are the products sold by Smart ePrint genuine?',
      'acceptedAnswer': {
        '@type': 'Answer',
    ...
    {
      '@type': 'Question',
      'name': 'Is Smart ePrint affiliated with any printer brand?',
      'acceptedAnswer': {
        '@type': 'Answer',
    ...
    {
      '@type': 'Question',
      'name': 'How can I contact Smart ePrint?',
      'acceptedAnswer': {
        '@type': 'Answer',
        'text': 'You can reach our support team anytime Email: support@smarteprint.com Phone: +1-651-815-4630 Address: 11397 Quincy St NE, Blaine, Minnesota 55434'
      }
    },
    {
      '@type': 'Question',
    ...
    {
      '@type': 'Question',
      'name': 'Why should I shop at Smart ePrint?',
      'acceptedAnswer': {
        '@type': 'Answer',
